...
// Tailsitter test
#define SENSOR_ROTOR_ANGLE_BIAS  (0)  //deg
#define SENDOR_PWM_MAX           (9475)
#define SENDOR_PWM_MIN           (285)
// End
...
float motor_angle_cal(uint32_t pwm_now, uint32_t pwm_max, uint32_t pwm_min, float angle_bias, bool reverse = false);
